...
# Calculo de W con regresion lineal y rlb // Calculo numerico de W con gradiente Descendente, Estoc, Mini Batch
...
# Funciones para Calculo de los Gradientes
...
def gradient_descent(X_train, y_train, lr=0.01, amt_epochs=100):
    ...
    #print ('\n', W)
    # Iteramos por la cantidad de epochs y recalculamos W
...
def mini_batch_gradient_descent(X_train, y_train, lr=0.01, amt_epochs=100):
    ...
    for i in range(amt_epochs):
        ...
        # En lugar de tomar todas las muestras o una sola, tomamos b muestras y Calculamos W e iteramos hasta rec. el dataset
...
# Ejemplo de fit con senoidal


def sin_fitting_example():
    # Generamos los puntos de un periodo de una señal senoidal
    # y = sin(x)
    amt_points = 36
    ...
    # Calculamos la regresion lineal con constante  Wx + b
    ...
    # Calculamos la regresion lineal con una funcion cuadratica
    ...
    # Calculamos la regresion lineal con una funcion cubica
    ...
    # Calculamos un polinomio de grado 10
    ...
    # Graficas de las funciones y comparacion
...
if __name__ == '__main__':
    ...
    # Creamos un objeto dataset para la carga del archivo
    dataset = Data('income.data.csv')

    # Calculo de Regresion Lineal y Reg. lineal con B y modelo constante
    ...
    # Calculo del error cuadratico medio de cada uno de los modelos
    ...
    # Calculo de los grandientes descendientes para la obtencion de W de forma numerica
    ...
    amt_epochs_1 = 1000
    start = time.time()
    # Cambiamos la dimension del X_train y el y_train de n --> nx1
    W_manual = gradient_descent(X_train.reshape(-1, 1), y_train.reshape(-1, 1), lr=lr_1, amt_epochs=amt_epochs_1)
    time_1 = time.time() - start
    # llamamos W_real a la W obtenida por formula cerrada a partir de la regresion lineal
    ...
    amt_epochs_2 = 100000
    start = time.time()
    # Al sumar el termino de b a los datos y trasnponer la dimension de X_train queda 2xn solo cambio la de Y_train
    ...
    # Gradiente Descendete Estocastico
